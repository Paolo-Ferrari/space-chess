...
/** Board pictogram — ncpd-officer (ncpd) */
export function Icon_NcpdOfficer() {
  return (
    <FactionIconSvg data-unit="ncpd-officer" data-faction="ncpd">
      ...
      <g className="ficon__glyph">
        <g transform="translate(0.00 -2.40)">
