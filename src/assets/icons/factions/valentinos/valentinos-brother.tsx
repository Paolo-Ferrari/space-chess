...
/** Board pictogram — valentinos-brother (valentinos) */
export function Icon_ValentinosBrother() {
  return (
    <FactionIconSvg data-unit="valentinos-brother" data-faction="valentinos">
