...
/** Board pictogram — valentinos-soldier (valentinos) */
export function Icon_ValentinosSoldier() {
  return (
    <FactionIconSvg data-unit="valentinos-soldier" data-faction="valentinos">
