...
/** Board pictogram — valentinos-guardian (valentinos) */
export function Icon_ValentinosGuardian() {
  return (
    <FactionIconSvg data-unit="valentinos-guardian" data-faction="valentinos">
